 ...
 */
@TableName("daohuoxinxi")
public class DaohuoxinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public DaohuoxinxiEntity() {
		
	}
	
	public DaohuoxinxiEntity(T t) {
		try {
	 ...
	 * 设置：订装费
	 */
	public void setDingzhuangfei(Double dingzhuangfei) {
		this.dingzhuangfei = dingzhuangfei;
	}
	/**
	 * 获取：订装费
	 */
	public Double getDingzhuangfei() {
		return dingzhuangfei;
	}
