 ...
 */
@TableName("huoyunpiaoju")
public class HuoyunpiaojuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public HuoyunpiaojuEntity() {
		
	}
	
	public HuoyunpiaojuEntity(T t) {
		try {
	...
	private String piaojuzhuangtai;
	 ...
	 * 设置：票据状态
	 */
	public void setPiaojuzhuangtai(String piaojuzhuangtai) {
		this.piaojuzhuangtai = piaojuzhuangtai;
	}
	/**
	 * 获取：票据状态
	 */
	public String getPiaojuzhuangtai() {
		return piaojuzhuangtai;
	}
